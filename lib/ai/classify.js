...
function classifyHeuristic(text) {
  ...
  return { domain: 'Unsupported', confidence: 0.2, rationale: 'The narrative does not contain enough reliable information to identify an RTI or Consumer matter.', suggested_category: '', is_valid_problem: value.length >= 12, ai_generated: false };
}
