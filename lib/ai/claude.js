    ...
    `https://generativelanguage.googleapis.com/v1beta/models/${encodeURIComponent(model)}:generateContent?key=${encodeURIComponent(apiKey)}`,
    {
      ...
      body: JSON.stringify({
        ...
        generationConfig: {
          ...
          // Gemini structured-output schemas use lowercase JSON Schema types.
          // The object constraint prevents prose-only responses from reaching
          // RightsTrack's strict JSON parsers.
